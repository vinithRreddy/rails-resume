...
class EducationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @education.update(education_params)
        format.html { redirect_to user_educations_path(@user), notice: 'Education was successfully updated.' }
  ...
  def destroy
    @education.destroy
    respond_to do |format|
      format.html {redirect_to user_educations_path(@user), notice: 'Education was successfully destroyed.' }
