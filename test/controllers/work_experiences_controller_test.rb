...
class WorkExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_experience" do
    assert_difference('WorkExperience.count') do
      post work_experiences_url, params: { work_experience: { company: @work_experience.company, end_date: @work_experience.end_date, position: @work_experience.position, start_date: @work_experience.start_date } }
    end
  ...
  test "should update work_experience" do
    patch work_experience_url(@work_experience), params: { work_experience: { company: @work_experience.company, end_date: @work_experience.end_date, position: @work_experience.position, start_date: @work_experience.start_date } }
