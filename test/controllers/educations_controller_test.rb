...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { end_date: @education.end_date, institute_name: @education.institute_name, marks: @education.marks, qualification: @education.qualification, specification: @education.specification, start_date: @education.start_date } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { end_date: @education.end_date, institute_name: @education.institute_name, marks: @education.marks, qualification: @education.qualification, specification: @education.specification, start_date: @education.start_date } }
